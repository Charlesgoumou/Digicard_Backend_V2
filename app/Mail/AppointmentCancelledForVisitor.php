...
/**
 * Email de notification au demandeur lors de l'annulation d'un rendez-vous.
 */
class AppointmentCancelledForVisitor extends Mailable
{
    /**
     * Le rendez-vous.
     */
    ...
    {
        return new Content(
            view: 'emails.appointments.cancelled-for-visitor',
            with: [
