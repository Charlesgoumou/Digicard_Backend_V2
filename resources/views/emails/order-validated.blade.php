...
<head>
    ...
    <title>Confirmation de votre commande - Arcc En Ciel</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>
                Nous avons le plaisir de vous confirmer que votre commande de cartes de visite digitales a été validée avec succès.
            </p>
            ...
            <div class="order-summary">
                ...
                <div class="order-info">
                    ...
                    <div class="order-info-row">
                        ...
                        <span class="order-info-value">{{ number_format($order->unit_price, 0, ',', ' ') }} GNF</span>
                    </div>
                    ...
                    <div class="order-info-row" style="margin-top: 15px; padding-top: 15px; border-top: 2px solid #cbd5e1;">
                        ...
                        <span class="order-info-value">{{ number_format($order->annual_subscription, 0, ',', ' ') }} GNF/an</span>
                    </div>
            ...
            <div class="cgu-section">
                ...
                <div style="background-color: #dbeafe; padding: 15px; border-radius: 5px; margin: 15px 0;">
                    ...
                    <p style="margin: 5px 0;"><strong>Abonnement annuel :</strong> {{ number_format($order->annual_subscription, 0, ',', ' ') }} GNF/an</p>
                    @if($order->order_type === 'business')
